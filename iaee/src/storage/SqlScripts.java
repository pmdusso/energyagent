...
public class SqlScripts
{
	...
	public static final String SELECT_NODES_UUID = "SELECT NODE_ID FROM Node;";
	...
	/**
	 * Insert int Energy Consumption table*/
	public static final String INSERT_ENERGY_CONSUMPTION = "INSERT INTO EnergyConsumption (NODE_ID, TIME_ID, TOTAL, CPU, DISK, MEM, NET, MISC) VALUES (%s, %s, %s, %s, %s, %s, %s, %s);";
