...
public class Transmit implements Serializable {
    ...
    private final int TX_CarrierErrors;
    private final int TX_Collisions;
    private final int TX_Compressed;
    private final int TX_Dropped;
    private final int TX_Erros;
    private final int TX_Fifo;
    private final int TX_Packets;
