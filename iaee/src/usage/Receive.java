...
public class Receive implements Serializable {
    ...
    private final int RX_Compressed;
    private final int RX_Dropped;
    private final int RX_Erros;
    private final int RX_Fifo;
    private final int RX_Frame;
    private final int RX_Multicast;
    private final int RX_Packets;
