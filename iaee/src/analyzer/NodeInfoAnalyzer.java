...
class NodeInfoAnalyzer {
    ...
    /**
     * @param mapActualCpu     : The collection with the least gathered CPU monitored data
     * @param mapPreviouslyCpu : The collection with the immediately previously gathered CPU
     *                         monitored data
     * @param core             : the number of the core. A "0" value means that is sum off
     *                         all cores
    ...
    /**
     * @param totalDiff : The total (sum of all CPU times) difference time between the
     *                  two CPU clock measures
     * @param idleDiff  : The total idle difference time between the two CPU clock
     *                  measures
